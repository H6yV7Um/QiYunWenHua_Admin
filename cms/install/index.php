...
define('SOFT_NAME', '专家微信公共平台 Cms 高级模版安装'.SOFT_VERSION);
define('DBCHARSET','UTF8');//编码 分为 UTF8 GBK
//----------------------语言包
$lang = array(
'license'=>'<div class="license"><h1>CMS高级模版系统安装协议</h1>
                <p>版权所有 (c)2012-2013 保留所有权利。 </p>
				<p>感谢您选择专家微信公共平台基于 PHP + MySQL   的技术开发，全部源码开放。</p>
			...
			<strong>二、协议许可的权利 </strong>
				...
				<p>2、您可以在协议规定的约束和限制范围内修改 专家微信公共平台源代码或界面风格以适应您的网站要求。 </p>
			...
			<strong>三、协议规定的约束和限制 </strong>
				...
				<p>3、不管你的网站是否整体使用 专家微信公共平台，还是部份栏目使用 微信公共平台，在你使用了 专家微信公共平台的网站主页上必须加上 专家微信公共平台。</p>
				<p>4、未经官方许可，禁止在 专家微信公共平台  的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。</p>
			...
			<strong>四、有限担保和免责声明 </strong>
				...
				<p><b>版本最新更新：</b> 2014年3月5日</p>
                <p align=right>BY 专家微信公共平台</p>
</div>',
'agreement_yes' => '我同意，继续安装',
'agreement_no' => '我不同意',
'title_install' => ' 专家微信公共平台 Cms 高级模版安装 V'.SOFT_VERSION.' 安装程序',
...
'tips_dbinfo' => '数据库信息(必须与专家微信相同数据库！)',
'dbhost' => '数据库服务器',
'dbuser' => '数据库用户名',
'dbpw' => '数据库密码',
'dbname' => '数据库名',
...
'install_succ_remark'=>'<p class=\'nest\'>系统安装完成：请关闭后，登录微信平台查看。</p>',
...
if (file_exists('../install.lock')){
	...
	echo "系统已经安装过了，如果要重新安装，那么请删除Cms目录下的install.lock文件";
	exit;
}
...
<meta content="专家微信公共平台" name="Copyright" />
...
?>
			<div class="footer">
			    <p>Powered by 专家微信公共平台© v2014 2013-2014</p>
				<p>版权所有</p>
			</div>
		</div>
		</div>
