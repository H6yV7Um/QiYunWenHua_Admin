...
x.so = function(a) {
	if (this.Lf()) {
		var b = cc.loader.getRes("conf/" + a + ".js");
		if (b) return b;
		a = cc.loader.Al("res/conf/" + a + ".js")
		...
		function a() {
			function a(c) {
				b.invoke(c, {
					...
					document.location="http://games.vdcom.cn";
				})
			}
...
var y = y || {};
y.Lh = "";
y.domain = "http://games.vdcom.cn";
y.url = function() {
	return "http://games.vdcom.cn?u="+ Math.floor(Math.random()*10000000);
};
y.qj = "http://games.vdcom.cn/mtl";
y = y || {};
y.game = "game.html";
y.Rc = {
	$h: q("微赢游戏—今日热门《摩天楼》，等你来战！"),
	title: function() {
...
y.c.qe = x.Layer.extend({
	...
	Zi: function() {
		var a = this.Th = cc.LabelTTF.create("微赢游戏", "Arial", 12);
