...
<div class="main">
    <section class="section" style="overflow:hidden;">
       ...
       <div class="share-btn">
		...
		<?php }?>
        <div class="share-btn">
          <a href="#" onClick="guanzhu();" style="color:#FFFFFF;">关注 微赢网络</a>
        </div>
...
<script type="text/javascript">
  var jump_url = "http://mp.weixin.qq.com/s?__biz=MzA4NTk2MzgxNg==&mid=200512824&idx=1&sn=fb2c29f97e981c8eb672d9e733750b96#rd";
function guanzhu(){
    ...
    (function(){
        ...
        var share_desc = share_desc_arr[city_i].replace(/{num}/, city_len);
          var share_url = "http://games.vdcom.cn/games/baba/share.php#"+ city_id;
