...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="addn">
 <form id="myform" action="<?php echo U('Site/insert');?>" method="post">
	...
	<tr> 
      ...
      ucenter添加应用时的授权地址应为：www.xxx.com/ucenter/advanced/examples/</span>。<span class="11">V</span><span class="111">3站长社</span><span class="hgag25">区www.c</span><span class="hffs3fsf2935">nv3.n</span><span class="hff9s525">et</span><span class="hff9s525">提</span><span class="hf9fd22425">供本源</span><span class="hff9s525">码</span>
