...
<div class="topbg">
    <div class="top">
        <div class="toplink">
            <style>
                .topbg {
                    BACKGROUND-IMAGE: url(<?php echo RES;?>/images/top.png);
                ...
                .top .toplink .memberinfo {
                    float: right;
                }
                
                .top .toplink .memberinfo a {
                    color: #999;
                }
                
                .top .toplink .memberinfo a:hover {
                    color: #F90
                }
                
                .top .toplink .memberinfo a.green {
                    background: none;
                    color: #0C0
                }
                ...
                .navr LI A:hover {
                    BACKGROUND: url(<?php echo RES;?>/images/navhover.gif) center no-repeat;
                    color: #009900;
                }
                
                .navr LI.menuon {
                    BACKGROUND: url(<?php echo RES;?>/images/navon.gif) center no-repeat;
                    display: block;
                    width: 103px;
                    HEIGHT: 32px;
                }
                ...
                .hbanner {
                    background: url(img/h2003070126.jpg) center no-repeat #B4B4B4;
                }
                
                .gbanner {
                    background: url(img/h2003070127.jpg) center no-repeat #264C79;
                }
                
                .jbanner {
                    background: url(img/h2003070128.jpg) center no-repeat #E2EAD5;
                }
                
                .dbanner {
                    background: url(img/h2003070129.jpg) center no-repeat #009ADA;
                }
                
                .nbanner {
                    background: url(img/h2003070130.jpg) center no-repeat #ffca22;
                }
            </style>
        ...
        <!--<div class="logo">-->
            ...
            <!--<div class="navr">-->
                <!--<ul id="topMenu">-->
                    <!--<li-->
                    <!--<?php if((ACTION_NAME == 'index') and (GROUP_NAME == 'Home')): ?>class="menuon"<?php endif; ?>-->
                    <!--&gt;<a href="/">首页</a></li>-->
                    <!--<li-->
                    <!--<?php if((ACTION_NAME) == "fc"): ?>class="menuon"<?php endif; ?>-->
                    <!--&gt;<a href="<?php echo U('Home/Index/fc');?>">功能介绍</a></li>-->
                    <!--<li-->
                    <!--<?php if((ACTION_NAME) == "about"): ?>class="menuon"<?php endif; ?>-->
                    <!--&gt;<a href="<?php echo U('Home/Index/about');?>">关于我们</a></li>-->
                    <!--<li-->
                    <!--<?php if((ACTION_NAME) == "price"): ?>class="menuon"<?php endif; ?>-->
                    <!--&gt;<a href="<?php echo U('Home/Index/price');?>">资费说明</a></li>-->
                    <!--<li-->
                    <!--<?php if((ACTION_NAME) == "common"): ?>class="menuon"<?php endif; ?>-->
                    <!--&gt;<a href="<?php echo U('Home/Index/common');?>">微信导航</a></li>-->
                    <!--<li-->
                    <!--<?php if((GROUP_NAME) == "User"): ?>class="menuon"<?php endif; ?>-->
                    <!--&gt;<a href="<?php echo U('User/Index/index');?>">管理中心</a></li>-->
                    <!--<li-->
                    <!--<?php if((ACTION_NAME) == "help"): ?>class="menuon"<?php endif; ?>-->
                    <!--&gt;<a href="<?php echo U('Home/Index/help');?>">帮助中心</a></li>-->
                <!---->
                <!--</ul>-->
            <!--</div>-->
        <!--</div>-->
...
<ul>
<form action="<?php if ($paytype == 'tenpay') { echo U('Tenpay/recharge'); } else if ($paytype == 'kuaiqian') { echo U('Alipay/kuaiqian'); } else { echo U('Alipay/recharge'); }?>" method="post" onsubmit="return checkcz()">
