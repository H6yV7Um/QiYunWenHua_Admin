...
th,td{text-align: -webkit-left;font-size:12px;}
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
		...
		<tr bgcolor="#F1F1F1">
			...
			<td>
				<div class="mr15 l">
                    ...
                    菜单图标码<input id="emoji_code" class="txt" name="emoji_code" title="主菜单前小图标" size="8" value="<?php echo ($show["emoji_code"]); ?>" type="text">
                    比如：e022  <a href="/tpl/static/emoji.htm" target="_blank"><img src="<?php echo RES;?>/images/help.png" class="vm helpimg" title="菜单图标码"></a>									
				</div>
		...
		<tr class="keyword" <?php if($show["keyword"] != ''): ?>dis=1<?php endif; ?>  style="display:none;">
		...
		<tr class="url" <?php if($show["url"] != ''): ?>dis=1<?php endif; ?>  style="display:none;">
		...
		<tr class="wxsys" <?php if($show["wxsys"] != ''): ?>dis=1<?php endif; ?>  style="display:none;">
