	  ...
	  <form class="form" method="post" action="" target="_top" enctype="multipart/form-data">	 
		<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
			<tbody>
                ...
                <?php if($set and ($infoType["type"] == 'Hotels')): ?><tr> 
					<th><span class="red"></span>订单短信验证：</th> 
					<td>开启&nbsp;<input type="radio" name="phone_authorize" value="1" <?php if($set["phone_authorize"] == 1): ?>checked<?php endif; ?> id="statu-1" value="1">&nbsp;&nbsp;
					关闭&nbsp;<input type="radio" name="phone_authorize" value="0" <?php if($set["phone_authorize"] == 0): ?>checked<?php endif; ?> id="statu-0" value="0"></td> 
				 </tr><?php endif; ?>
				<th>&nbsp;</th>
					<td>
