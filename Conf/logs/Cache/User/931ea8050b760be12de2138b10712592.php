     ...
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      <tbody>
       ...
       <tr>
        ...
        <td><input type="text" id="email" name="email" value="<?php echo ($setting["email"]); ?>" placeholder="如：<?php echo C('site_email');?>" class="px" style="width:250px;" />&nbsp;&nbsp;
	        开启&nbsp;<input type="radio" name="email_status" <?php if($setting["email_status"] == 1): ?>checked<?php endif; ?> id="statu-1" value="1">&nbsp;&nbsp;
	        关闭&nbsp;<input type="radio" name="email_status" <?php if($setting["email_status"] == 0): ?>checked<?php endif; ?> id="statu-0" value="0"></td> 
       </tr>
