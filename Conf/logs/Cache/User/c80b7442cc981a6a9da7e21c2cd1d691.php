			...
			<tbody>
				<tr>
					...
					<td>
						...
						</select> 开启支付后，商城等b2c功能将有在线支付功能。</a>
						...
						<td>
							<div class="pay_setting">
								...
								<div class="hidden" id="platform_setting">
									<div class="setting_rows">
										<p><span>名称标注：</span><input type="text" name="platform[platformName]" value="<?php echo ($config["platform"]["platformName"]); ?>" class="px" />&nbsp;&nbsp;支付时的支付名称额外的标注【如：<font color="red">支付宝(<?php echo ($f_siteName); ?>)</font>】，不填写则不展示</p>
									</div>
								</div>
							</div>
						</td>
