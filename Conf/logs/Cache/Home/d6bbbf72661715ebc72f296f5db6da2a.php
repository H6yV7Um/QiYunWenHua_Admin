...
<div class="topbg">
    <div class="top">
                ...
                <div class="document" style="margin-top:0px;">
                    ...
                    <div class="collapsible">
                        <div class="section lastSection">
                            <p>请务必认真阅读以下2步内容，才能更有效的完成配置工作，有疑问的请联系QQ：<?php echo ($f_qq); ?>提问。<br/>
                                <?php if($_GET['token'] != ''): ?>你的接口URL是：<font color="red"><?php echo ($f_siteUrl); ?>/index.php/api/
                                    <?php echo $_GET['token']; ?>
                                </font><br>您的token是：<font color="red">
                                    <?php if($wxuser['pigsecret']){echo $wxuser['pigsecret'];}else{echo $_GET['token'];} ?>
                                </font><?php endif; ?>
                            </p>
                        </div>
                        <div id="CollapsiblePanel2" class="CollapsiblePanel">
                            <div class="CollapsiblePanelTab clicked">第一步、在<?php echo ($f_siteName); ?>绑定你的微信公众号。<span></span>
                            </div>
                            <div style="" class="">
                        ...
                        <div id="CollapsiblePanel3" class="CollapsiblePanel">
                            ...
                            <div style="" class="">
                                <div class="articleContent catalogHome normalContent">
                                    <div class="section lastSection">
                                        <div class="section lastSection">
                                            <p>1、登录 <a href="http://mp.weixin.qq.com/">微信公众平台</a>（<a
                                            ...
                                            <p>3、填写接口配置信息</p>
                                            <?php if($_GET['token'] == ''): ?><p>
                                                    比如你<?php echo ($f_siteName); ?>平台上的地址是<?php echo ($f_siteUrl); ?>/index.php/api/demo</p>
                                                <p>那么URL就是<?php echo ($f_siteUrl); ?>/INDEX.PHP/api/demo</p>
                                                <?php else: ?>
                                                <p>你的URL是 <font color="red"><?php echo ($f_siteUrl); ?>/index.php/api/
                                                    <?php echo $_GET['token']; ?>
                                                </font></p><?php endif; ?>
                                            <p>Token填写 <font color="red">
                                                <?php echo $_GET['token']; ?>
                                            </font></p>
        ...
        <script type="text/javascript">try {
          Dd('webpage_7').className = 'left_menu_on';
        } catch (e) {
        }</script>