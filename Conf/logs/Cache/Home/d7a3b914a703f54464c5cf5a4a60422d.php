...
<!--<div class="top">-->
<!--<div class="top1000">-->
<!--&lt;!&ndash;<div class="top_l"><a href=""><img src="<?php echo RES;?>/images/logo2.png"/></a></div>&ndash;&gt;-->
<!--</div>-->
<!--</div>-->
<div class="main-content">
    <div class="main1000"><img class="phone" alt="phone" src="<?php echo RES;?>/images/phone.png" id="zll"
                               style="top:120px;display: inline;">
        <p class="txt1"><img src="<?php echo RES;?>/images/login_huanyin.png" width="251" height="109"/></p>
        <form action="<?php echo U('Users/checklogin');?>" enctype="multipart/form-data" onsubmit="return onpost()"
            ...
            <div class="login">
                ...
                <p class="pass-form-item">
                    <input type="checkbox" checked="checked" class="pass-checkbox-input" name="memberPass"
                           style="border:none;">
                    <label class="" id="TANGRAM__PSP_1__memberPassLabel" for="TANGRAM__PSP_1__memberPass"
                           style="  height: auto;line-height: 18px;width: auto; border:none; background:none;">记住我的登录状态</label>
                </p>
                <p class="pass-form-item">
                    ...
                    <li style=" width:545px;">
                        <div class="w545">
                            ...
                            <div class="products-desc">
                                <h3 class="title">什么是微信管家</h3>
                                <div class="desc"> 微信管家是一个集微信公众接口、微信达人、微信资讯，旨在通<br>过方便实用的接口帮助微信营销用户管理提高个人和团队效率的管理产品。
                                    通过"微信导航"为微信玩家们更好的找到自己喜欢的微信。
                                </div>
                            </div>
                        </div>
                    </li>
                            ...
                            <div class="products-desc">
                                <div class="w545">
                                    ...
                                    <div class="desc"> 提供 超强小黄鸡陪聊+40多款便民功能，微会员（SCRM），微活动 <br>
                                        微团购+刮刮乐+一战到底+微信喜帖+在线订餐+自定义订单+3G相册<br>+优惠券+幸运大转盘的会员再营销，超炫微信3G网站,等您需要的各种<br>微信营销模块。
                                    </div>
                                </div>
                            </div>
                        </div>
