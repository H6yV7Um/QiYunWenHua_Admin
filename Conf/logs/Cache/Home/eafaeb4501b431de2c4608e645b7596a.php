...
<div class="top">
<div class="top1000"><div class="top_l"><a href=""><img src="<?php echo RES;?>/images/logo2.png"/></a></div></div> 
</div>
...
<div class="main-content">
 <div class="main1000">
   ...
   <div class="reg_index">
    <p>
       ...
       <p>
        ...
        <span id="err_registeremail"><font color="#FF0000">*</font>邮箱将与支付及优惠相关，请填写正确的邮箱,<font color="red">注册后无法修改</font>。</span>
      </p>
       <p>
        <label>QQ</label>
   ...
   <input type="hidden" name="__hash__" value="6c1c1dfda0c28dd4837d7b4e06f5ea85_4db3ab8cbfa518793ee977b5449abe7a" /></form>
    <div class="foot"><?php echo C('copyright');?> <?php echo C('ipc');?> <a href="#" target="_blank">微信接口</a>| <a href="#" target="_blank">微信第三方接口</a> | <a href="#" target="_blank">微信机器人</a> | 联系我们 隐私条款 </div>
 </div>
</div>
