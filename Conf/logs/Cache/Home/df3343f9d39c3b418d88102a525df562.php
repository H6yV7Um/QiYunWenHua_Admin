...
<div class="people"><img src="<?php echo RES;?>/images/ren3.jpg" class="f_l"><span><span class="hisname">刘佳佳</span><span class="profiler">曼妮莎女装运营经理</span></span></div>
</div><!--end conbox-->
</div><!--end conmentcon-->
</div><!--end conmenter-->
...
<div id="footer">
    <div class="di">
        <span class="banQ f_l">&copy;<?php echo ($f_siteName); ?>信息科技有限公司&nbsp;&nbsp;<a href="http://www.miibeian.gov.cn/" target="_blank"><?php echo C('ipc');?></a></span>
     ...
     <span class="houT f_r">
     <a href="<?php echo U('Agent/Index/index');?>" target="_blank"><?php echo ($f_siteName); ?>代理管理系统</a></span></div>
</div>
