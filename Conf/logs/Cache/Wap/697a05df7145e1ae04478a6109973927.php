...
<p class="act">
	<a href="<?php echo U('Store/index',array('token'=>$_GET['token'], 'wecha_id'=>$_GET['wecha_id'], 'twid' => $twid));?>" class="back">继续购物<i></i></a>
	<a href="<?php echo U('Store/orderCart',array('token'=>$_GET['token'], 'wecha_id'=>$_GET['wecha_id'], 'twid' => $twid));?>" class="checkout">下单结算</a>
</p>
</div>
<?php else: ?>
<div class="m-cart-e">
...
window.shareData = {  
            ...
            "moduleID":"0",
            "imgUrl": "", 
            "timeLineLink": "<?php echo C('site_url') . U('Store/cart',array('token' => $_GET['token'], 'twid' => $mytwid));?>",
            "sendFriendLink": "<?php echo C('site_url') . U('Store/cart',array('token' => $_GET['token'], 'twid' => $mytwid));?>",
            "weiboLink": "<?php echo C('site_url') . U('Store/cart',array('token' => $_GET['token'], 'twid' => $mytwid));?>",
